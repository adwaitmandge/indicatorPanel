                    ...
                    <form className="w-full lg:w-auto">
                      <div className="mx-auto flex max-w-xs flex-col justify-center sm:max-w-md sm:flex-row lg:mx-0">
                        <input
                          ...
                          className="form-input mb-2 w-full appearance-none rounded-sm border border-gray-700 bg-gray-800 px-4 py-3 text-white placeholder-gray-500 focus:border-gray-600 focus:outline-none active:outline-none sm:mb-0 sm:mr-2"
                          placeholder="Query..."
                          aria-label="Query..."
                        />
                        {!loading ? (
                          ...
                          <button
                            disabled
                            type="button"
                            class="mr-2 inline-flex items-center rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                          >
                            <svg
                              aria-hidden="true"
                              role="status"
                      ...
                      <p className="mt-3 text-sm text-gray-400">Start Now!</p>
                    </form>
                    {/* Empty input toast */}
                  </div>
                </div>
